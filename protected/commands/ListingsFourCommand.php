...
class ListingsFourCommand extends CConsoleCommand
{
...
//            "195.154.161.107:9800",
    ...
    public function scrapeListing(){
        $url = 'https://www.propertyguru.com.sg/property-for-rent?sort=date&order=desc&market=residential&property_type_code%5B%5D=CONDO&property_type_code%5B%5D=APT&property_type_code%5B%5D=WALK&property_type_code%5B%5D=CLUS&property_type_code%5B%5D=EXCON&property_type=N&newProject=all';
        while ( 1 === 1){
            $cards = array();
            $dom = new DOMDocument();
