...
class ListingsFiveCommand extends CConsoleCommand
{
...
//            "195.154.161.107:9800",
    ...
    public function scrapeListing(){
        $url = 'https://www.propertyguru.com.sg/property-for-rent?sort=date&order=desc&market=residential&property_type_code%5B%5D=TERRA&property_type_code%5B%5D=DETAC&property_type_code%5B%5D=SEMI&property_type_code%5B%5D=CORN&property_type_code%5B%5D=LBUNG&property_type_code%5B%5D=BUNG&property_type_code%5B%5D=SHOPH&property_type_code%5B%5D=RLAND&property_type_code%5B%5D=TOWN&property_type_code%5B%5D=CON&property_type_code%5B%5D=LCLUS&property_type=L&newProject=all';
        while ( 1 === 1){
            $cards = array();
            $dom = new DOMDocument();
